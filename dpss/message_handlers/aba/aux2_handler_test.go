...
func Aux2TestSetup(r, vote int) (*MockTransport, []*Node, *common.PSSMessage, common.PSSRoundDetails) {
	...
	msg, error := NewAux2Message(round, vote, r, common.CurveName(c.Name))
