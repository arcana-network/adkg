...
func TestStartDualAcss(t *testing.T) {
	...
	commitments_old, _ := sharing.DecompressCommitments(oldParams.K, sentCommitments_old, testutils.TestCurve())
	...
	commitments_new, _ := sharing.DecompressCommitments(newParams.K, sentCommitments_new, testutils.TestCurve())
