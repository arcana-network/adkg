...
// 		coeff = append(coeff, common.CurveFromName(testutils.TestCurveName()).Scalar.Random(rand.Reader))
// 	}

// 	testMsg.Coefficients = sharing.CompressScalars(coeff)
// 	testMsg.Process(senderNode.Details(), receiverNode)
...
// 	users := []string{}
// 	for i := range r.PSSRoundDetails.BatchSize {
// 		coeff = append(coeff, curve.Scalar.Random(rand.Reader))
...
// 		Coefficients:        sharing.CompressScalars(coeff),
// 		UserIds:             users,
// 		T:                   []int{1, 2},
// 	}
// 	return msg
