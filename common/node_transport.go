...
// 	ProcessMessage(senderDetails NodeDetails, message DKGMessage) error
...
// // TODO can this receive a msg also when a node has 2 pubkeys
// func (tp *NodeTransport) Receive(senderDetails NodeDetails, nodeMessage DKGMessage) error {
...
// 	}
// 	var pubKey Point
// 	// E: a msg contains a pubkey of the node for whom this message is intended
...
// // TODO Solution might be to move this to KeygenNode and make a separate impl PssNode
...
// func (tp *NodeTransport) Send(nodeDetails NodeDetails, nodeMessage DKGMessage) error {
// 	log.WithFields(log.Fields{
...
// 	// Checks whether it is node itself. In that case the msg is processed using "Receive"
// 	if nodeDetails.PubKey.X.Cmp(&pubKey.X) == 0 && nodeDetails.PubKey.Y.Cmp(&pubKey.Y) == 0 {
// 		return tp.Receive(nodeDetails, nodeMessage)
// 	}

// 	// Otherwise, we start looking for the recipient
